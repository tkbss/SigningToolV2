namespace NavigationModule
{
    public class NavigationURI
    {
        ...
        public static Uri keySetupToolbarViewUri = new Uri("KeyManagementToolbarView", UriKind.Relative);
        public static Uri keyGenerationViewUri = new Uri("KeyGenerationView", UriKind.Relative);
        public static Uri ATMkeyGenerationToolbvarViewUri = new Uri("ATMKeyGenerationToolbarView", UriKind.Relative);
        public static Uri QAkeyGenerationToolbvarViewUri = new Uri("QAKeyGenerationToolbarView", UriKind.Relative);
        public static Uri HSMStatusViewUri = new Uri("HSMStatusView", UriKind.Relative); 
        public static Uri MANUKeyGenerationToolbarViewUri = new Uri("MANUKeyGenerationToolbarView", UriKind.Relative);
        public static Uri KMSQAKeyGenerationToolbarViewUri = new Uri("KMSQAKeyGenerationToolbarView", UriKind.Relative);
        public static Uri KMSATMKeyGenerationToolbarViewUri = new Uri("KMSATMKeyGenerationToolbarView", UriKind.Relative);
        public static Uri TraceDataViewUri = new Uri("TraceDataView", UriKind.Relative);
        public static Uri TraceDataToolbarViewUri = new Uri("TraceDataToolbarView", UriKind.Relative);
