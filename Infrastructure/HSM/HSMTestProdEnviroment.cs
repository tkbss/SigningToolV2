...
{
    public class HSMTestProdEnviroment: HSMBaseEnviroment, IEnviroment
    {
        ...
        public string PublicKey(int slot,string cert_type,string e)
        {
            string kn=tk.DeterminePublicKeyName(cert_type,e);
        ...
        public string SigningKeyName(string cert_type,string env)
        {
            return tk.DetermineSigningKeyName(cert_type,env);
        }
